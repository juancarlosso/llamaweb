    ...
    <div class="col-md-7 align-self-center text-end">
        <div class="d-flex justify-content-end align-items-center">
            <ol class="breadcrumb justify-content-end">
                ...
                <li class="breadcrumb-item active"><a href="javascript:void(0)">Agregar Cliente</a></li>
            </ol>
            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <div class="basic-form">
                        <form id="frmDatos" method="post" action="{{route('clientes.store')}}" enctype="multipart/form-data">
                            @csrf
                            <div class="row">
                                <div class="form-group col-md-6">
                                    <label>Nombre<span class="text-danger">*</span></label>
                                    <input type="text" class="form-control" placeholder="" name="nombre" value="{{old('nombre')}}">
                                </div>
                                <div class="form-group col-md-6">
                                    <label>Ejecutivo<span class="text-danger">*</span></label>
                                    <input type="text" class="form-control" placeholder="" name="ejecutivo" value="{{old('ejecutivo')}}">
                                </div>
                            </div>
                            <div class="row">
                                <div class="form-group col-md-6">
                                    <label>Teléfono de ejecutivo<span class="text-danger">*</span></label>
                                    <input type="text" class="form-control" placeholder="" name="telefono" value="{{old('telefono')}}">
                                </div>
                            </div>
